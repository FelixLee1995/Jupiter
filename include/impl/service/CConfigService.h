...
#include <functional>
#include "util.h"
#include "CConfigService.h"
#include "core/CLexicalCast.h"


#include <interface/service/IConfigService.h>
#include <core/MyMutex.h>

namespace jupiter{
    class CConfigService: public IConfigService
    {
    private:
        /* data */
    public:
        CConfigService() = default;
        ~CConfigService() override;
        void Init() override;
        void Dispose() override;
        template<class T>T LookUpConfigVar(const std::string& key, T defaultValue);
